...
namespace ClassiCraft {
    public class CmdHBox : Command {
        public override string Name {
            get { return "HBox"; }
        }

        public override string Syntax {
            get { return "/hbox [material]"; }
        }
        ...
        public override void Use( Player p, string args ) {
            ...
            p.SendMessage( "&cHBox: &ePlace a block at the first corner." );
        ...
        void Blockchange1( Player p, ushort x, ushort y, ushort z, byte type ) {
            ...
            p.SendMessage( "&cHBox: &ePlace a block at the second corner." );
        ...
        void Blockchange2( Player p, ushort x2, ushort y2, ushort z2, byte type ) {
            ...
            p.SendMessage( "&cHBox: &eBox drawn, modified " + buffer.Count + " blocks. (" + XDiff + "x" + YDiff + "x" + ZDiff + ")" );
        }

        public override void Help( Player p ) {
            p.SendMessage( "Draws a hollow box between two points." );
        }
    }
}
